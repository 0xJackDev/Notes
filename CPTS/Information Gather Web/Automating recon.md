...
```shell-session
JackTheWizard@htb[/htb]$ git clone https://github.com/thewhiteh4t/FinalRecon.git
JackTheWizard@htb[/htb]$ cd FinalRecon
JackTheWizard@htb[/htb]$ pip3 install -r requirements.txt
JackTheWizard@htb[/htb]$ chmod +x ./finalrecon.py
JackTheWizard@htb[/htb]$ ./finalrecon.py --help
...
```shell-session
JackTheWizard@htb[/htb]$ ./finalrecon.py --headers --whois --url http://inlanefreight.com
